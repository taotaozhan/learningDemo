...
public class FileController {
  ...
  //后缀名
  private static final String[] IMAGE_SUFFIXES = {"jpg","png","bmp"};
  //大小
  private static final long  IMAGE_MAX_SIZE = 2*1024*1024;
  //存放根目录
  private static final File ROOT = new File("D:temp");

  @PostMapping(value = "/single",consumes = {MediaType.MULTIPART_FORM_DATA_VALUE},produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
  @ResponseBody
